const capabilities = Object.freeze([
  ...
  { id:"project-integrity",category:"workflow",label:"工程安全与恢复",status:"complete",detail:"项目锁、原子写入、上一版本备份、损坏隔离恢复、100 步日志、手动快照、格式迁移与显式修复" },
  { id:"independent-ai",category:"ai-editing",label:"独立 AI 模式",status:"complete",detail:"内置 OpenAI、Anthropic 与兼容接口配置和对话规划，无需 Codex/Claude；所有写入仍需人工批准" },
  { id:"high-level-orchestration",category:"ai-editing",label:"高级工作流入口",status:"complete",detail:"创建、导入、开放式规划、审核应用和严格完成导出由少量高级工具编排底层能力" },
  { id:"macos-lifecycle",category:"workflow",label:"macOS 安装与生命周期",status:"complete",detail:"提供安装、依赖检查、更新、卸载和诊断脚本，卸载默认保留工程、素材与设置" },
  { id:"review-transport",category:"manual-editing",label:"专业审片控制",status:"complete",detail:"J/K/L 穿梭、空格播放、I/O 区间、全屏、适应画面和键盘撤销" },
